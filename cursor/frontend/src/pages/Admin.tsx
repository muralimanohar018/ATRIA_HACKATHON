...
import { Plus, Loader2, Briefcase, FileText, Users, Filter, Download, Eye, LogOut, Shield, BarChart, Sparkles, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      {selectedApplication && (
        ...
        >
          <GlassCard className="max-w-3xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
